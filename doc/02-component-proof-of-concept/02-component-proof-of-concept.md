...
- **3/1 @ 11:59 PM**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
I'm going with the password hashing algorithm for now. It would present more of a challenge for me and push me to look more into the java.util components, which there is a lot of. I feel if I am able to complete this project then I can achieve my second preferred idea (anime list) with more confidence and more easily. Plus, the hashing algorithms I would need to implement are more relevent to what I aim to pursue in the future.
