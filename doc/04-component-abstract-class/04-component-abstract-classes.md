...
It's very possible for me. Because the majority of the work for the main secondary method encrypt is going to be done using private fields, the kernel methods I need are fine enough. I just need to know the algorithm, which uses "getAlgorithm()". Other methods like "toString()" and "equals()" use base java as well.
