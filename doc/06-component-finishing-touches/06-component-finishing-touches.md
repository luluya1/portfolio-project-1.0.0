...
I think I actually understand objects better, which is a little embarassing given this is the second course in the sequence. Interfaces and their uses also make more sense to me now. What they're used for, how to format them, etc. And how interfaces are used alongside classes (abstract and otherwise). I think my project was simpler than others, and so the kernel methods and their uses feel a little useless to me than just putting everything within one class, but I see the vision. Sorta.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

My knowledge on OOP and class setup was severely lacking. Creating my own objects and setting up the abstract classes and interfaces helped a lot. My project utilizes enums, which I wasn't too confident on, and I used online resources to gain a better understanding of them, such as Stack Overflow and CodeRanch. If I have a question than surely someone else had it, too!

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

I guess I'm really realizing how complicated and tedious not only the coding itself, but the planning and constructing of it all. Making sure things are eligble and make sense to outsiders and also you yourself later. Having to keep track of values and conditions you set for youself. It takes time! And energy. I had fun doing it though. It's always fun to have the pieces click together in my mind, though it usually takes a while.
...
Organization! I tend to have a way of organizing things that is thrilling for me (sometimes) and a pain for others. Through this project I've gained better oganizational skills, as coding everything in one big file or with odd naming conventions will lead to a giant mess. Also, problem solving, since I got frustrated a few times on how I wanted something to be represented.

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

-Able to keep things organized and understandable for team members and outsiders
-Detect problems and find effective solutions

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.

I'm more interested. I wanted to attempt more complex encryption methods like RSA, and maybe I will add it to this project in the future. I find security fascinating and scary.
...
I'd have to do more research on network security policies and standards, as well as the security methods employed by professionals. There's a lot of information out there. I'm not sure who I could contact... I'd probably have to start somewhere simple first, though. I want to do a help desk job at some point to get some hands on experience first.
